...
-   `Eager` ist in Angular 22 zwar gültig (neuer Name für `CheckAlways`, Zoneless-Ära), aber das _explizite_ Setzen auf jeder Komponente ist ein von `ng update` generierter Kompatibilitäts-Workaround, kein Zielzustand.

...
describe("RosMockService", () => {
    ...
    it("should send a motor-settings message", () => {
        ...
        const motorSettings: MotorSettingsMessage = {
        ...
        service.sendMotorSettingsMessage(motorSettings);
        expect(sendMotorSettingsSpy).toHaveBeenCalledOnceWith(motorSettings);
        expect(consoleInfoSpy).toHaveBeenCalledOnceWith(
            '{"motor_name":"test-motor","turned_on":false,"pulse_width_min":0,"pulse_width_max":1,"rotation_range_min":2,"rotation_range_max":3,"velocity":4,"acceleration":5,"deceleration":6,"period":7,"visible":false}',
        );
    });
